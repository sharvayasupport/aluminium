    ...
    <div class="container">
        ...
        <div class="row gy-4">
                ...
                <div class="portfolio-details-slider swiper">
                    <div class="swiper-wrapper align-items-center">
                        ...
                        <div class="swiper-slide">
                            <img src="img/gallery_main_img_7.jpg" alt="">
                        </div>

                        <div class="swiper-slide">
                            <img src="img/gallery_main_img_8.jpg" alt="">
                        </div>
            ...
            <div class="col-lg-7">
              <div class="portfolio-info">
                ...
                <ul>
                  ...
                  <li><strong>Diameter</strong>: 10mm To 380mm</li>
                  <li><strong>Length</strong>: 3660mm (3.66MTR)</li>
            ...
            <div id="Description" class="tabcontent">
                <h3>Description</h3>
                <p>Our Aluminium Round Bar is supplied in grade 6061-T6, 6082-T6,. Often referred to as an 'architectural alloy', this material has high strength and can be easily cut or welded with the right equipment. The bar shape lends itself to many building projects particularly outdoors, where it has a very good resistance to corrosion and high mechanical strength..</p>
                <p>  Round bar is typically used for:</p>

                <P>•  Road transport</p>
                <p>  •  Frames</p>
                <p>   •  Gardening products</p>
                <p>   •  Shop fitting </p>
                <p>   •  General fabrications</p>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="background-color: #D9DADA;
                                ...
                                font-size: 16px;
                                transition: 0.4s;
                                font-family: Montserrat,sans-serif;">19 %</td>
